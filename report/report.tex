...
\begin{itemize}
  ...
  \item We believe that a decision transformer (at least in our implementation and at our scale) is incapable of truly in-context learning new tasks or embodiments.
    However we are confident that training a new task or embodiment requires orders of magnitude less demonstrations and this way enables in-context learning in a soft sense.
    At least for related tasks or similar embodiments.
\end{itemize}
