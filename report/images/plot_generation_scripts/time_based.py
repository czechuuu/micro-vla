"""These are the results from ICL carried out on PH lift task with negative time based rewards (-1 at every step, +100 on success - meant to help discriminate between the better and worse trajectories)."""
...
ax.set_title('PH Lift (w/ time based rewards) Success Rate Metrics per Epoch')
...
plt.tight_layout()
plt.savefig('time_based.png', dpi=300)