"""These are the results from the baseline ICL carried out on the Lift task."""
...
data = {
    ...
    17: [12.5, 25.0, 37.5],
    18: [50.0, 37.5, 50.0],
    19: [75.0, 75.0, 87.5] # FYI - it looks like an upwards trend, but its not - I tried evaluating on 30 epochs and got similar results
}
...
ax.set_title('Standard_Lift Success Rate Metrics per Epoch')
...
plt.tight_layout()
plt.savefig('baseline_icl.png', dpi=300)